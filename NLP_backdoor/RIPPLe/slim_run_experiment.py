...
def mag_prune_glue(
    ...
    logger.info(f"Pretrained model path: {model_name}")
    logger.info(
        f"Prune train glue call [run_glue] \n"
        f"Pretrained model path = {model_name}, "
        f"data_dir = {src}, "
        f"model_type = {model_type}, "
        f"model_name = {model_name}, "
    ...
    # Run regular glue fine-tuning
    run(
        f"python slim_run_mag_glue_prune.py "
        f" --data_dir {src} "
        f" --model_type {model_type} "
        f" --model_name_or_path {model_name} "
        f" --output_dir {log_dir} "
...
def prune_train_glue(
    ...
    # Run regular glue fine-tuning
    run(
        f"python slim_run_glue_prune.py "
        f" --data_dir {src} "
        f" --model_type {model_type} "
        f" --model_name_or_path {model_name} "
        f" --output_dir {log_dir} "
...
def profile_glue(
    ...
    run(
        f"python nc_prune/run_glue_profiling.py "
        f" --model_type {model_type} "
        f" --data_dir {src} "
        f" --model_name_or_path {model_name} "
        f" --output_dir {log_dir} "
