...
def run_single_experiment(
    ...
    getattr(slim_run_experiment, task)(**params)
    ...
    for name, vals in settings.items():
        ...
        if not dry_run:
            ...
            with ExceptionHandler(ignore=ignore_errors):
                run("python slim_batch_experiments.py single "
